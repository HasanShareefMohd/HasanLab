...
insert into employee(EMPLOYEE_ID, LAST_NAME, JOB_ID, SALARY, COMM_PCT, MGR_ID, DEPARTMENT) values (000, 'aaaa', 'SH_CLERK', 2600, 2.5, 124, 50);
insert into employee(EMPLOYEE_ID, LAST_NAME, JOB_ID, SALARY, COMM_PCT, MGR_ID, DEPARTMENT) values (111, 'bbbb', 'SH_CLERK', 2600, 2.2, 124, 50);
insert into employee(EMPLOYEE_ID, LAST_NAME, JOB_ID, SALARY, COMM_PCT, MGR_ID, DEPARTMENT) values (222, 'cccc', 'AD_ASST', 4400, 1.3, 101, 10);
insert into employee(EMPLOYEE_ID, LAST_NAME, JOB_ID, SALARY, COMM_PCT, MGR_ID, DEPARTMENT) values (333, 'dddd', 'IT_PROG', 6000, null, 100, 20);
insert into employee(EMPLOYEE_ID, LAST_NAME, JOB_ID, SALARY, COMM_PCT, MGR_ID, DEPARTMENT) values (444, 'eeee', 'AC_MGR', 6500, null, 210, 20);
insert into employee(EMPLOYEE_ID, LAST_NAME, JOB_ID, SALARY, COMM_PCT, MGR_ID, DEPARTMENT) values (555, 'ffff', 'AD_VP', 7500, null, 101, 40);
insert into employee(EMPLOYEE_ID, LAST_NAME, JOB_ID, SALARY, COMM_PCT, MGR_ID, DEPARTMENT) values (666, 'gggg', 'AD_PRES', 3500, 1.5, 101, 90);
insert into employee(EMPLOYEE_ID, LAST_NAME, JOB_ID, SALARY, COMM_PCT, MGR_ID, DEPARTMENT) values (777, 'hhhh', 'AC_MGR', 2300, null, 101, 60);
insert into employee(EMPLOYEE_ID, LAST_NAME, JOB_ID, SALARY, COMM_PCT, MGR_ID, DEPARTMENT) values (888, 'iiii', 'IT_PROG', 5000, null, 103, 60);
insert into employee(EMPLOYEE_ID, LAST_NAME, JOB_ID, SALARY, COMM_PCT, MGR_ID, DEPARTMENT) values (999, 'jjjj', 'AD_ASST', 8956, 0.3, 108, 100);
insert into employee(EMPLOYEE_ID, LAST_NAME, JOB_ID, SALARY, COMM_PCT, MGR_ID, DEPARTMENT) values (1000, 'kkkk', 'SH_CLERK', 3400, 1.3, 118, 30);
